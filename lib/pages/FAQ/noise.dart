        ...
        const Text.rich(
          TextSpan(
            ...
            children: [
              ...
              TextSpan(text: "   - 바닥이 고르지 않으면 진동과 소음이 커집니다.\n"),
              TextSpan(
                text:
                    "   - 수평계 또는 물컵을 이용해 기울어짐이 없는지 확인하고, 수평 조절 다리로 높이를 맞춰주세요.\n\n",
              ),
              TextSpan(
                text: "2. 세탁물이 한쪽으로 치우치지 않았는지 확인하세요.\n",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              TextSpan(text: "   - 세탁물이 한쪽 통에만 몰리면 탈수 시 큰 소음이 발생합니다.\n"),
              TextSpan(
                text: "   - 세탁물을 꺼내 적당량으로 나누어 넣거나, 통 안에서 고르게 펼쳐주세요.\n\n",
              ),
              TextSpan(
                text: "3. 세탁물 과다 여부를 확인하세요.\n",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              TextSpan(text: "   - 허용 용량을 초과하면 모터와 통에 무리가 가면서 소음이 커집니다.\n"),
              TextSpan(text: "   - 한 번에 넣는 양을 줄이고, 필요한 경우 두 번에 나누어 세탁하세요.\n\n"),
              TextSpan(
                text: "4. 주머니나 세탁조 내부 이물질을 점검하세요.\n",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              TextSpan(
                text: "   - 동전, 열쇠, 단추 등 딱딱한 물체가 통 안을 돌며 부딪히면 큰 소리가 납니다.\n",
              ),
              TextSpan(text: "   - 세탁 전 주머니를 비우고, 세탁조 내부를 한 번 훑어 확인해 주세요.\n\n"),
              TextSpan(
                text: "5. 바닥 진동 패드 사용을 고려해 보세요.\n",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              TextSpan(
                text:

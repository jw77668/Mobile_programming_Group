  ...
  Widget build(BuildContext context) {
    return FAQPage(
      ...
      contents: [
        ...
        // 해결 방법 내용
        const Text(
          "1. 세탁기 전원을 끄고, 반드시 플러그를 콘센트에서 뽑습니다.\n"
          "2. 세탁기 전면 하단의 작은 커버를 열어 배수 필터 위치를 찾습니다.\n"
          "3. 바닥에 물을 받을 수 있는 낮은 통이나 수건을 준비합니다.\n"
          "4. 필터를 시계 반대 방향으로 돌려 천천히 분리하면서, 남은 물이 흘러나오도록 합니다.\n"
          "5. 분리한 필터에 붙은 먼지, 머리카락, 작은 이물질을 손이나 브러시로 제거한 뒤, 흐르는 물에 깨끗이 씻어줍니다.\n"
          "6. 필터 주변의 고무 패킹(패킹 부분에 낀 이물질)도 부드러운 천으로 닦아줍니다.\n"
          "7. 필터를 다시 제자리에 넣고, 시계 방향으로 끝까지 단단히 돌려 잠급니다.\n"

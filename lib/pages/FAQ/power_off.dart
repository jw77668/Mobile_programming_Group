  ...
  Widget build(BuildContext context) {
    return FAQPage(
      ...
      contents: [
        ...
        // 해결 방법 내용
        const Text(
          "1. 사용 중인 콘센트에 전기가 정상적으로 들어오는지 확인하세요.\n"
          "   - 같은 콘센트에 다른 전자제품(스탠드, 드라이기 등)을 꽂아 켜지는지 테스트해 보세요.\n\n"
          "2. 전원 플러그가 완전히 꽂혀 있는지 확인하세요.\n"
          "   - 플러그가 느슨하게 꽂혀 있으면 전원이 들어오지 않을 수 있습니다.\n"
          "   - 플러그와 콘센트 사이에 이물질이 끼지 않았는지도 확인해 주세요.\n\n"
          "3. 집 안 차단기(두꺼비집)가 내려가 있지 않은지 확인하세요.\n"
          "   - 순간적인 과전류나 정전으로 인해 차단기가 내려간 경우, 해당 스위치를 올려 다시 전원을 공급해 주세요.\n\n"
          "4. 세탁기 도어가 완전히 닫혀 있는지 확인하세요.\n"
          "   - 일부 모델은 도어 잠금이 제대로 되지 않으면 전원이 켜지지 않거나, 동작이 시작되지 않습니다.\n"
          "   - 도어 주변에 옷감이나 이물질이 끼어 있지 않은지 확인하세요.\n\n"
          "5. 전원 버튼을 2~3초 이상 길게 눌러보세요.\n"
          "   - 모델에 따라 짧게 누르면 반응하지 않고, 길게 눌러야 전원이 켜지는 경우가 있습니다.\n\n"
          "6. 정전 후 일정 시간 대기 후 다시 시도해 보세요.\n"
